...
{
public:
    virtual ~RenderAPI_Vulkan() override = default;
...
private:
    ...
    VkRenderPass m_TrianglePipelineRenderPass = VK_NULL_HANDLE;
...
unsigned int RenderAPI_Vulkan::GetCurrentFramebuffer()
{
    return 0;
}

void* RenderAPI_Vulkan::GetHwProcAddress(const char* /*sym*/)
{
    return nullptr;
}

void RenderAPI_Vulkan::InitFramebuffer(void* /*texture*/, int /*width*/, int /*height*/, bool /*depth*/, bool /*stencil*/)
{
}

void RenderAPI_Vulkan::DeinitFramebuffer()
{
}
